...
# <div style="text-align:center">last update: <b>10/19/2018</b></div>
# 
# 
# 
...
# * Embarked
#  
# The Titanic data set has a number of interesting features:
# 
# 1. One of the classes   is linearly separable from the others. However, the other  classes are not linearly separable.
# 
# 2. There is some overlap between  classes, so it is unlikely to achieve a perfect classification rate.
# 
# 3. There is some redundancy in the ten input variables, so it is possible to achieve a good solution with only three of them, or even (with difficulty) from two, but the precise choice of best variables is not obvious.
# 
# **Why am I  using titanic dataset:**
# 
...
# * [6] [competitive data science](https://www.coursera.org/learn/competitive-data-science/)
# 
# 
# -------------
# 
